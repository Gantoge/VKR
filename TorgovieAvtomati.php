...
<body>
    ...
    <nav>
        <div class="nav-logo">
            ...
            <div class="exit-login"><b>Привет</b>, <font color="#BB0E0E">
                    <?php echo htmlspecialchars($_SESSION['username']); ?></font>!</div>
    ...
    <header>
        <div class="main-text">
            <span>Парки Москвы являются популярными местами для отдыха горожан и туристов. Установка
                торговых автоматов в парковых зонах предоставляет отличные возможности для ведения успешного бизнеса с
                минимальными вложениями и максимальной отдачей.</span>
        </div>
        <img class="img-header" src="img/vending_parks.jpg" alt="Торговый Автомат"
            style="margin: 60px auto 0px auto; display:block">
