...
<head>
    ...
    <title>Передвижные торговые объекты</title>
...
<body>
    ...
    <h2>
                <font align="center">Какие бывают виды передвижных объектов?</font>
    </h2>
            <div>
                <li><b>Палатки:</b> Небольшие мобильные конструкции для продажи продуктов или товаров.</li>

            </div>
            <div>
                <li><b>Фургоны и автомобили:</b> Автотранспортные средства,
                    оборудованные для продажи готовой еды, напитков, мороженого и других товаров.</li>

            </div>
            <div>
                <li><b>Прицепы и мобильные киоски:</b> Маленькие прицепы или стационарные киоски,
                    которые могут быть прицеплены к автомобилю и использоваться для продажи товаров или услуг.</li>


            </div>
            <div>
                <li><b>Плавучие стойки:</b> Используются на водных путях для продажи товаров или услуг с лодок или
                    плавсредств.</li>

            </div>
            <div>
                <li><b>Мобильные кафе и рестораны:</b> Рестораны и кафе, установленные на колесах или в виде
                    автобусов,
                    которые могут перемещаться по городу и обслуживать клиентов.</li>

            </div>
        </div>
            <img class="img-header" src="img/image 18.png" alt="Передвижной объект" style="margin:60px auto 80px auto; display:block">
