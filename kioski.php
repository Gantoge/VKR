...
<body>
    ...
    <header>
        <div class="main-text">
        Уличный киоск покупать не придется: их Москва сдает
            в аренду. Там можно торговать мороженым, напитками,
            сэндвичами, кондитерскими изделиями и другой едой,
            а также открыть пункт аренды спортинвентаря. Полный
            список есть в документе (.doc) 
            <a href="files/Распоряжение ДТиУ г. Москвы от 21.08.2012 N 136 (ред. от 20.06.2018).docx" download>по
            ссылке.</a></span>
        </div>
        <img class="img-header" src="img/kioski-header.png" alt="Киоск" style="margin:60px auto 0px auto; display:block">
